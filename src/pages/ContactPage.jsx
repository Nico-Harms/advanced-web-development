...
export default function ContactPage() {
    ...
    <div className="font-mont font-semibold flex flex-col mt-3 gap-3 text-xs md:text-base md:gap-6  md:justify center">
        ...
        <h2 className="text-2xl font-bebas mb-4 md:text-3xl lg:text-4xl flex gap-4">Bageri <InstagramLogo size={32} color="prime-brown" /></h2>
        ...
        <h2 className="text-2xl font-bebas  mb-4 md:text-3xl lg:text-4xl md:mt-6 flex gap-4">Café <InstagramLogo size={32} color="prime-brown" /></h2>
        <div className=" font-mont flex gap-3">
